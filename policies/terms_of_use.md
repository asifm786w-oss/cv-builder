...
- If under 18, you are using the Service with the permission and supervision of a parent or guardian who accepts these Terms on your behalf  
...
The Service may be available with or without user accounts.
...
- Suggest wording for CVs and related documents  
...
By using the Service, you grant us a limited licence to:
- Process Your Content to provide the Service  
- Use anonymised or aggregated data to improve the Service  

We do not sell Your Content.

You confirm that:
- You have the right to upload and use Your Content  
...
You must not:
- Copy or reproduce templates for resale  
- Create a competing service using substantially similar designs or workflows  
...
- Paid plans with extended features  

We may:
- Change usage limits  
- Introduce or modify pricing  
- Add or remove features  

Any paid plans will be subject to additional terms at the time of purchase.
...
- Discontinue the Service, acting reasonably  
...
- We make no guarantees about the accuracy or suitability of outputs  
- We do not guarantee any employment or career outcomes  

You are responsible for:
- Reviewing generated documents  
- Deciding how to use the content  
...
Certain data may be retained where required by law or legitimate operational needs, in line with the Privacy Policy.
...
The courts of **England and Wales** have exclusive jurisdiction, unless applicable law provides otherwise.
