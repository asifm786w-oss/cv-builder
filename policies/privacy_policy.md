...
- Any other information you enter into your CV or cover letter  
- Job descriptions you paste into the Service  
- Free-text references or notes  
...
- Pages visited  
- Buttons clicked (e.g. “Generate CV”, “Improve bullets”)  
- Template types used  
- Time and date of access  
- Basic device or browser information  

This data helps us understand how the Service is used and improve reliability and usability.
...
1. **Service providers (processors)**  
   Trusted third parties that help operate the Service, such as:
   - Hosting providers  
   - AI model providers  
   - Email or communication services  
   - Error logging or analytics tools  

   These providers process data only on our instructions and under appropriate safeguards.

2. **Legal or regulatory bodies**  
